...
$sql = "SELECT bookreader FROM bookhistory WHERE (20-(CEILING(({$time} - time) / 86400000)))=5 AND active=1";
...
try {                   
    ...
    $mail->Subject = 'Library Alert - 5 Days';
    $mail->MsgHTML('you have 5 days to <b>return the book!</b>');
    $mail->AltBody = 'you have 5 days to return the book!';
