...
$sql = "SELECT bookreader FROM bookhistory WHERE (20-(CEILING(({$time} - time) / 86400000)))=2 AND active=1";
...
try {                   
    ...
    $mail->Subject = 'Library Alert - 2 Days';
    $mail->MsgHTML('you have 2 days to <b>return the book!</b>');
    $mail->AltBody = 'you have 2 days to return the book!';
