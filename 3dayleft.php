...
$sql = "SELECT bookreader FROM bookhistory WHERE (20-(CEILING(({$time} - time) / 86400000)))=3 AND active=1";
...
try {                   
    ...
    $mail->Subject = 'Library Alert - 3 Days';
    $mail->MsgHTML('you have 3 days to <b>return the book!</b>');
    $mail->AltBody = 'you have 3 days to return the book!';
