...
$sql = "SELECT bookreader FROM bookhistory WHERE (20-(CEILING(({$time} - time) / 86400000)))=1 AND active=1";
...
try {                   
    ...
    $mail->Subject = 'Library Alert - 1 Day';
    $mail->MsgHTML('you have 1 day to <b>return the book!</b>');
    $mail->AltBody = 'you have 1 day to return the book!';
